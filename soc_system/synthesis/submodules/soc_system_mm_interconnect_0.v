...
module soc_system_mm_interconnect_0 (
		...
		input  wire        nios_cpu_pio_reset_reset_bridge_in_reset_reset, // nios_cpu_pio_reset_reset_bridge_in_reset.reset
		input  wire [17:0] nios2_cpu_data_master_address,                  //                    nios2_cpu_data_master.address
		...
		input  wire [17:0] nios2_cpu_instruction_master_address,           //             nios2_cpu_instruction_master.address
		...
		output wire [1:0]  nios_cpu_pio_s1_address,                        //                          nios_cpu_pio_s1.address
		input  wire [31:0] nios_cpu_pio_s1_readdata,                       //                                         .readdata
	...
	wire  [17:0] nios2_cpu_data_master_translator_avalon_universal_master_0_address;              // nios2_cpu_data_master_translator:uav_address -> nios2_cpu_data_master_agent:av_address
	...
	wire   [5:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> nios2_cpu_data_master_agent:rp_channel
	...
	wire  [17:0] nios2_cpu_instruction_master_translator_avalon_universal_master_0_address;       // nios2_cpu_instruction_master_translator:uav_address -> nios2_cpu_instruction_master_agent:av_address
	...
	wire   [5:0] rsp_mux_001_src_channel;                                                         // rsp_mux_001:src_channel -> nios2_cpu_instruction_master_agent:rp_channel
	...
	wire  [93:0] cmd_mux_src_data;                                                                // cmd_mux:src_data -> jtag_uart_1_avalon_jtag_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                               // jtag_uart_1_avalon_jtag_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [5:0] cmd_mux_src_channel;                                                             // cmd_mux:src_channel -> jtag_uart_1_avalon_jtag_slave_agent:cp_channel
	...
	wire  [94:0] i2c_0_csr_agent_rf_source_data;                                                  // i2c_0_csr_agent:rf_source_data -> i2c_0_csr_agent_rsp_fifo:in_data
	...
	wire  [94:0] i2c_0_csr_agent_rsp_fifo_out_data;                                               // i2c_0_csr_agent_rsp_fifo:out_data -> i2c_0_csr_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> i2c_0_csr_agent:cp_data
	...
	wire  [17:0] nios2_cpu_debug_mem_slave_agent_m0_address;                                      // nios2_cpu_debug_mem_slave_agent:m0_address -> nios2_cpu_debug_mem_slave_translator:uav_address
	...
	wire  [93:0] cmd_mux_002_src_data;                                                            // cmd_mux_002:src_data -> nios2_cpu_debug_mem_slave_agent:cp_data
	...
	wire  [31:0] nios_cpu_pio_s1_agent_m0_readdata;                                               // nios_cpu_pio_s1_translator:uav_readdata -> nios_cpu_pio_s1_agent:m0_readdata
	wire         nios_cpu_pio_s1_agent_m0_waitrequest;                                            // nios_cpu_pio_s1_translator:uav_waitrequest -> nios_cpu_pio_s1_agent:m0_waitrequest
	wire         nios_cpu_pio_s1_agent_m0_debugaccess;                                            // nios_cpu_pio_s1_agent:m0_debugaccess -> nios_cpu_pio_s1_translator:uav_debugaccess
	wire  [17:0] nios_cpu_pio_s1_agent_m0_address;                                                // nios_cpu_pio_s1_agent:m0_address -> nios_cpu_pio_s1_translator:uav_address
	wire   [3:0] nios_cpu_pio_s1_agent_m0_byteenable;                                             // nios_cpu_pio_s1_agent:m0_byteenable -> nios_cpu_pio_s1_translator:uav_byteenable
	wire         nios_cpu_pio_s1_agent_m0_read;                                                   // nios_cpu_pio_s1_agent:m0_read -> nios_cpu_pio_s1_translator:uav_read
	wire         nios_cpu_pio_s1_agent_m0_readdatavalid;                                          // nios_cpu_pio_s1_translator:uav_readdatavalid -> nios_cpu_pio_s1_agent:m0_readdatavalid
	wire         nios_cpu_pio_s1_agent_m0_lock;                                                   // nios_cpu_pio_s1_agent:m0_lock -> nios_cpu_pio_s1_translator:uav_lock
	wire  [31:0] nios_cpu_pio_s1_agent_m0_writedata;                                              // nios_cpu_pio_s1_agent:m0_writedata -> nios_cpu_pio_s1_translator:uav_writedata
	wire         nios_cpu_pio_s1_agent_m0_write;                                                  // nios_cpu_pio_s1_agent:m0_write -> nios_cpu_pio_s1_translator:uav_write
	wire   [2:0] nios_cpu_pio_s1_agent_m0_burstcount;                                             // nios_cpu_pio_s1_agent:m0_burstcount -> nios_cpu_pio_s1_translator:uav_burstcount
	wire         nios_cpu_pio_s1_agent_rf_source_valid;                                           // nios_cpu_pio_s1_agent:rf_source_valid -> nios_cpu_pio_s1_agent_rsp_fifo:in_valid
	wire  [94:0] nios_cpu_pio_s1_agent_rf_source_data;                                            // nios_cpu_pio_s1_agent:rf_source_data -> nios_cpu_pio_s1_agent_rsp_fifo:in_data
	wire         nios_cpu_pio_s1_agent_rf_source_ready;                                           // nios_cpu_pio_s1_agent_rsp_fifo:in_ready -> nios_cpu_pio_s1_agent:rf_source_ready
	wire         nios_cpu_pio_s1_agent_rf_source_startofpacket;                                   // nios_cpu_pio_s1_agent:rf_source_startofpacket -> nios_cpu_pio_s1_agent_rsp_fifo:in_startofpacket
	wire         nios_cpu_pio_s1_agent_rf_source_endofpacket;                                     // nios_cpu_pio_s1_agent:rf_source_endofpacket -> nios_cpu_pio_s1_agent_rsp_fifo:in_endofpacket
	wire         nios_cpu_pio_s1_agent_rsp_fifo_out_valid;                                        // nios_cpu_pio_s1_agent_rsp_fifo:out_valid -> nios_cpu_pio_s1_agent:rf_sink_valid
	wire  [94:0] nios_cpu_pio_s1_agent_rsp_fifo_out_data;                                         // nios_cpu_pio_s1_agent_rsp_fifo:out_data -> nios_cpu_pio_s1_agent:rf_sink_data
	wire         nios_cpu_pio_s1_agent_rsp_fifo_out_ready;                                        // nios_cpu_pio_s1_agent:rf_sink_ready -> nios_cpu_pio_s1_agent_rsp_fifo:out_ready
	wire         nios_cpu_pio_s1_agent_rsp_fifo_out_startofpacket;                                // nios_cpu_pio_s1_agent_rsp_fifo:out_startofpacket -> nios_cpu_pio_s1_agent:rf_sink_startofpacket
	wire         nios_cpu_pio_s1_agent_rsp_fifo_out_endofpacket;                                  // nios_cpu_pio_s1_agent_rsp_fifo:out_endofpacket -> nios_cpu_pio_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                           // cmd_mux_005:src_valid -> nios_cpu_pio_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                            // cmd_mux_005:src_data -> nios_cpu_pio_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                           // nios_cpu_pio_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                         // cmd_mux_005:src_channel -> nios_cpu_pio_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                   // cmd_mux_005:src_startofpacket -> nios_cpu_pio_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                     // cmd_mux_005:src_endofpacket -> nios_cpu_pio_s1_agent:cp_endofpacket
	...
	wire  [93:0] jtag_uart_1_avalon_jtag_slave_agent_rp_data;                                     // jtag_uart_1_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [93:0] i2c_0_csr_agent_rp_data;                                                         // i2c_0_csr_agent:rp_data -> router_003:sink_data
	...
	wire  [93:0] nios2_cpu_debug_mem_slave_agent_rp_data;                                         // nios2_cpu_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire         nios_cpu_pio_s1_agent_rp_valid;                                                  // nios_cpu_pio_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] nios_cpu_pio_s1_agent_rp_data;                                                   // nios_cpu_pio_s1_agent:rp_data -> router_007:sink_data
	wire         nios_cpu_pio_s1_agent_rp_ready;                                                  // router_007:sink_ready -> nios_cpu_pio_s1_agent:rp_ready
	wire         nios_cpu_pio_s1_agent_rp_startofpacket;                                          // nios_cpu_pio_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         nios_cpu_pio_s1_agent_rp_endofpacket;                                            // nios_cpu_pio_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         nios_cpu_pio_s1_agent_rdata_fifo_src_valid;                                      // nios_cpu_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] nios_cpu_pio_s1_agent_rdata_fifo_src_data;                                       // nios_cpu_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         nios_cpu_pio_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_005:in_0_ready -> nios_cpu_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                               // avalon_st_adapter_005:out_0_valid -> nios_cpu_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                // avalon_st_adapter_005:out_0_data -> nios_cpu_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                               // nios_cpu_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                               // avalon_st_adapter_005:out_0_error -> nios_cpu_pio_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) nios_cpu_pio_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios_cpu_pio_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (nios_cpu_pio_s1_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (nios_cpu_pio_s1_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (nios_cpu_pio_s1_agent_m0_read),                  //                         .read
		.uav_write              (nios_cpu_pio_s1_agent_m0_write),                 //                         .write
		.uav_waitrequest        (nios_cpu_pio_s1_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (nios_cpu_pio_s1_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (nios_cpu_pio_s1_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (nios_cpu_pio_s1_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (nios_cpu_pio_s1_agent_m0_writedata),             //                         .writedata
		.uav_lock               (nios_cpu_pio_s1_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (nios_cpu_pio_s1_agent_m0_debugaccess),           //                         .debugaccess
		.av_address             (nios_cpu_pio_s1_address),                        //      avalon_anti_slave_0.address
		.av_readdata            (nios_cpu_pio_s1_readdata),                       //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) nios_cpu_pio_s1_agent (
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios_cpu_pio_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (nios_cpu_pio_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (nios_cpu_pio_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (nios_cpu_pio_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (nios_cpu_pio_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (nios_cpu_pio_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (nios_cpu_pio_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (nios_cpu_pio_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (nios_cpu_pio_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (nios_cpu_pio_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (nios_cpu_pio_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (nios_cpu_pio_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (nios_cpu_pio_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (nios_cpu_pio_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (nios_cpu_pio_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (nios_cpu_pio_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (nios_cpu_pio_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (nios_cpu_pio_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (nios_cpu_pio_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (nios_cpu_pio_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (nios_cpu_pio_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (nios_cpu_pio_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (nios_cpu_pio_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (nios_cpu_pio_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (nios_cpu_pio_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (nios_cpu_pio_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (nios_cpu_pio_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                //                .error
		.rdata_fifo_src_ready    (nios_cpu_pio_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (nios_cpu_pio_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (nios_cpu_pio_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) nios_cpu_pio_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios_cpu_pio_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (nios_cpu_pio_s1_agent_rf_source_data),             //        in.data
		.in_valid          (nios_cpu_pio_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (nios_cpu_pio_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (nios_cpu_pio_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (nios_cpu_pio_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (nios_cpu_pio_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (nios_cpu_pio_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (nios_cpu_pio_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (nios_cpu_pio_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (nios_cpu_pio_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	soc_system_mm_interconnect_0_router_003 router_007 (
		.sink_ready         (nios_cpu_pio_s1_agent_rp_ready),                 //      sink.ready
		.sink_valid         (nios_cpu_pio_s1_agent_rp_valid),                 //          .valid
		.sink_data          (nios_cpu_pio_s1_agent_rp_data),                  //          .data
		.sink_startofpacket (nios_cpu_pio_s1_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (nios_cpu_pio_s1_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios_cpu_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios_cpu_pio_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (nios_cpu_pio_s1_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (nios_cpu_pio_s1_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (nios_cpu_pio_s1_agent_rdata_fifo_src_ready),     //         .ready
